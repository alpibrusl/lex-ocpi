...
fn test_encode_failure() -> Result[Unit, Str] {
  let r := env.fail(status.unknown_location(), "Unknown Location", "2026-05-15T10:00:00Z")
...
fn suite() -> List[Result[Unit, Str]] {
  [test_encode_success_empty(), test_encode_success_with_data(), test_encode_failure(), test_parse_success(), test_parse_failure_carries_message(), test_parse_invalid_json(), test_parse_missing_code(), test_round_trip(), test_is_success(), test_is_client_error(), test_is_server_error()]
}
