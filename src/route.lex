...
type OcpiRequest = { method :: Str, module :: Str, path :: Str, path_params :: Map[Str, Str], query :: Map[Str, Str], headers :: headers.OcpiHeaders, body :: jv.Json }

fn request(method :: Str, module :: Str, path :: Str, path_params :: Map[Str, Str], query :: Map[Str, Str], hdrs :: headers.OcpiHeaders, body :: jv.Json) -> OcpiRequest {
  { method: method, module: module, path: path, path_params: path_params, query: query, headers: hdrs, body: body }
}
...
type RouteEntry = { method :: Str, module :: Str, validator :: Option[(jv.Json) -> Result[jv.Json, List[e.Error]]], handler :: (OcpiRequest) -> HandlerResult }

type Registry = { routes :: List[RouteEntry], on_unknown :: (OcpiRequest) -> HandlerResult }
...
fn handler(reg :: Registry, method :: Str, module :: Str, h :: Handler) -> Registry {
...
fn handler_with_schema(reg :: Registry, method :: Str, module :: Str, validator :: Validator, h :: Handler) -> Registry {
...
fn run_entry(entry :: RouteEntry, req :: OcpiRequest, timestamp :: Str) -> env.OcpiResponse {
