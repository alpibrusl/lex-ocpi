...
type Version = { version :: Str, url :: Str }

fn version(v :: Str, url :: Str) -> Version
  examples {
    version("2.2.1", "https://cpo.example.com/ocpi/2.2.1") => { version: "2.2.1", url: "https://cpo.example.com/ocpi/2.2.1" }
  }
{
  { version: v, url: url }
}
...
fn version_to_json(v :: Version) -> jv.Json {
  JObj([("version", JStr(v.version)), ("url", JStr(v.url))])
}
...
type Endpoint = { identifier :: Str, role :: Str, url :: Str }
...
fn endpoint_sender(identifier :: Str, url :: Str) -> Endpoint
  examples {
    endpoint_sender("locations", "https://x/locations") => { identifier: "locations", role: "SENDER", url: "https://x/locations" }
  }
{
...
fn endpoint_receiver(identifier :: Str, url :: Str) -> Endpoint
  examples {
    endpoint_receiver("credentials", "https://x/credentials") => { identifier: "credentials", role: "RECEIVER", url: "https://x/credentials" }
  }
{
...
fn endpoint_to_json(e :: Endpoint) -> jv.Json {
  JObj([("identifier", JStr(e.identifier)), ("role", JStr(e.role)), ("url", JStr(e.url))])
}
...
type VersionDetail = { version :: Str, endpoints :: List[Endpoint] }
...
fn detail_to_json(d :: VersionDetail) -> jv.Json {
  JObj([("version", JStr(d.version)), ("endpoints", JList(list.map(d.endpoints, endpoint_to_json)))])
}
...
fn standard_cpo_v221_endpoints(base :: Str) -> List[Endpoint] {
  [endpoint_receiver(mid.credentials(), concat3(base, "/", "credentials")), endpoint_sender(mid.locations(), concat3(base, "/", "locations")), endpoint_sender(mid.sessions(), concat3(base, "/", "sessions")), endpoint_sender(mid.cdrs(), concat3(base, "/", "cdrs")), endpoint_sender(mid.tariffs(), concat3(base, "/", "tariffs")), endpoint_receiver(mid.tokens(), concat3(base, "/", "tokens")), endpoint_receiver(mid.commands(), concat3(base, "/", "commands")), endpoint_receiver(mid.chargingprofiles(), concat3(base, "/", "chargingprofiles")), endpoint_receiver(mid.hubclientinfo(), concat3(base, "/", "hubclientinfo"))]
}
...
fn standard_cpo_v230_endpoints(base :: Str) -> List[Endpoint] {
  list_concat(standard_cpo_v221_endpoints(base), [endpoint_sender(mid.payments(), concat3(base, "/", "payments"))])
}
...
fn standard_emsp_v221_endpoints(base :: Str) -> List[Endpoint] {
  [endpoint_receiver(mid.credentials(), concat3(base, "/", "credentials")), endpoint_receiver(mid.locations(), concat3(base, "/", "locations")), endpoint_receiver(mid.sessions(), concat3(base, "/", "sessions")), endpoint_receiver(mid.cdrs(), concat3(base, "/", "cdrs")), endpoint_receiver(mid.tariffs(), concat3(base, "/", "tariffs")), endpoint_sender(mid.tokens(), concat3(base, "/", "tokens")), endpoint_sender(mid.commands(), concat3(base, "/", "commands"))]
}
