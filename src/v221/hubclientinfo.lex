...
fn client_info_schema() -> s.ModelSchema {
  { title: "ClientInfo", description: "OCPI 2.2.1 — ClientInfo object", fields: [s.required_str("country_code", [StrNonEmpty, StrMaxLen(2)]), s.required_str("party_id", [StrNonEmpty, StrMaxLen(3)]), s.required_str("role", [StrOneOf(role.all_roles_v221())]), s.required_str("status", [StrOneOf(all_connection_status())]), s.required_str("last_updated", [StrNonEmpty])] }
}
