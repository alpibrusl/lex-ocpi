...
fn build_authorize_url(base :: Str, token_uid :: Str) -> Str
  examples {
    build_authorize_url("https://emsp.example/ocpi/2.1.1/tokens", "RFID-A") => "https://emsp.example/ocpi/2.1.1/tokens/RFID-A/authorize"
  }
{
...
fn authorize_token(base :: Str, token_uid :: Str, token_b64 :: Str, location_refs :: Option[jv.Json]) -> [net] Result[auth.AuthorizationResult, client.ClientError] {
